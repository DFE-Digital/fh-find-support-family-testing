describe('FHG-956-FX-filter-catSEND.spec',function(){
    it('Special educational needs and disabilities (SEND) support category - clear filters ',function(){
       ...
       //Autistic Spectrum Disorder (ASD)','Breaks and respite','Early years support','Groups for parents and carers of children with SEND','Hearing impairment','Multi-sensory impairment','Other difficulties or disabilities','Physical disabilities','Social, emotional and mental health support','Speech, language and communication needs','Visual impairment','Learning difficulties and disabilities',
       let subcategories = ['Autistic Spectrum Disorder (ASD)','Breaks and respite','Groups for parents and carers of children with SEND','Hearing impairment','Other difficulties or disabilities','Physical disabilities','Social, emotional and mental health support','Speech, language and communication needs','Visual impairment','Learning difficulties and disabilities']
       let subcatcode = ['1','2','4','5','8','9','10','11','12']
       for (let i=0; i< subcatcode.length; i++){
        cy.activitiesFilter2('5',`${subcatcode[i]}`,`${subcategories[i]}`)
